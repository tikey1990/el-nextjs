...
import { MethodsApiGenerator, ApiDecodingServices, CallApiMethod, ExampleApi, ApiHeading, ApiKey } from "./components";
    ...
    return (
        <div className="w-full flex h-auto z-[100] flex-row gap-6">
            <div className="flex flex-col gap-16 w-full sm:gap-6">
                {/* Ваш API ключ */}
                <DecoratorIntersectionObserver className={classDecorators} name="Ваш API ключ" register={register}>
                    <ApiKey name="Ваш API ключ" />

                    {/* Вызов методов API */}
                    <DecoratorIntersectionObserver name="Вызов методов API" register={register} className="">
